...
public class Window extends JFrame {
	...
	public Window(final Env env) {
		...
		addButton("prohibited.gif", "Prohibited zone", envView.tool.STATE_ADDPROHIBITED, envView.tool);
	...
	private static final int TOOLBAR_ICON_SIZE = 24; // ajuste este valor pro tamanho que os outros ícones usam

	private ImageIcon makeIcon(String sImage) {
		sImage = "images/toolbar/" + sImage;
		Image original = new ImageIcon(this.getClass().getResource(sImage)).getImage();
		Image scaled = original.getScaledInstance(TOOLBAR_ICON_SIZE, TOOLBAR_ICON_SIZE, Image.SCALE_SMOOTH);
